...
class SetNickInline extends Inline
{
	public function __construct($update, $tgLog, $loop, \User $user) {
		...
		[$foldingUserId, $foldingUserName, $foldingTeamId, $foldingTeamName] = $this->params;
		$user->update(null, intval($foldingUserId), $foldingUserName, intval($foldingTeamId), $foldingTeamName);
